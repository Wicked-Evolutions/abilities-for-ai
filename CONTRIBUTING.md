# Contributing to Abilities for AI
...
4. Your environment (WordPress version, PHP version, plugin version, multisite or single-site, any third-party suites active — Astra, Spectra, Presto Player, SureCart)
...
We track feature requests as GitHub issues and prioritize based on how they fit the product direction.
...
- PSR-4 autoloading under `WickedEvolutions\AbilitiesForAI`
- WordPress coding standards for hook names and option keys
- Consistent with existing code patterns

## Adding a new ability

If you want to register a new ability — either a new core ability or one for a third-party plugin suite — see [docs/guides/register-an-ability.md](docs/guides/register-an-ability.md) for the schema, capability, and category conventions we use.
